...
def fpga_alloc_dma_send(board, length, buf=None, share_buffer=None):
    return libxdma.fpga_alloc_dma_send(board, length, buf, share_buffer)


def fpga_alloc_dma_recv(board, length, buf=None, share_buffer=None):
    return libxdma.fpga_alloc_dma_recv(board, length, buf, share_buffer)
